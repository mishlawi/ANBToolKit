...
_lr_productions = [
  ...
  ('Person -> Names Nickname Dates','Person',3,'p_person','gramma.py',88),
  ('Person -> Names Dates','Person',2,'p_person','gramma.py',89),
  ('Person -> UND','Person',1,'p_person','gramma.py',90),
  ('Dates -> LP DATE DATE RP','Dates',4,'p_dates','gramma.py',113),
  ('Dates -> LP DATE NDY RP','Dates',4,'p_dates','gramma.py',114),
  ('Dates -> LP DATE UNK RP','Dates',4,'p_dates','gramma.py',115),
  ('Dates -> LP UNK NDY RP','Dates',4,'p_dates','gramma.py',116),
  ('Dates -> LP UNK DATE RP','Dates',4,'p_dates','gramma.py',117),
  ('Dates -> UNK','Dates',1,'p_dates','gramma.py',118),
  ('Children -> Children Child','Children',2,'p_children','gramma.py',139),
  ('Children -> Child','Children',1,'p_children','gramma.py',140),
  ('Children -> empty','Children',1,'p_children','gramma.py',141),
  ('Child -> POINT Person NEWLINE','Child',3,'p_child','gramma.py',157),
  ('Nickname -> LP Names RP','Nickname',3,'p_nickname','gramma.py',165),
  ('empty -> <empty>','empty',0,'p_empty','gramma.py',173),
]
